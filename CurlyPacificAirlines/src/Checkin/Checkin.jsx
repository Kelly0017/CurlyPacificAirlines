        ...
        return (
            <div className="checkin">
                <div className="col-md-8">
                    <p>Please Follow the Chart Below to Check0-In Your Seat:</p>
                    ...
                    <b>* Please note: An additional of P150.00 will be charged with seats for first row of every side of the plane because of extra leg room available </b>
                ...
                <div className="col-md-3 col-sm-offset-1">
                    ...
                    <h2>Total:</h2>
                    <h2>P {this.state.priceToBePaid}</h2>
                    <br/>
                    <p>
